...
def parameter_parser():
    parser = argparse.ArgumentParser(description="Run GEDIOT.")

    parser.add_argument('--test-k', type=int, default=100,help='Set k for inference.')
    parser.add_argument('--trainingset', choices=['training', 'small'],default='training', help="Choose a testing graph set: training, small.")
    parser.add_argument('--testset', choices=['test', 'small', 'large','unseen'],default='test', help="Choose a testing graph set: test, small, or large.")
