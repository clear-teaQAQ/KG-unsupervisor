"""Arguments for the isolated V2 executable-path audit."""
...
def parameter_parser():
    parser = argparse.ArgumentParser(
        description="Audit frozen V1 mappings as executable simple-graph and multi-relation paths."
    )
    ...
    parser.add_argument(
        "--result-path",
        default="experiments/seabed_versions/v2_edit_path_audit/results",
    )
    parser.add_argument("--model-path", default="model_save/")
    parser.add_argument("--model-name", default="GEDRankerSEABED_v2_edit_path_audit")
