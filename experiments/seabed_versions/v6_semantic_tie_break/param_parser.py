"""Arguments for the isolated V6 semantic tie-break evaluation."""
...
def parameter_parser():
    parser = argparse.ArgumentParser(
        description="Evaluate dual-cost-preserving embedding-cosine semantic repair."
    )
    ...
    parser.add_argument("--testset", choices=["test"], default="test")
    ...
    parser.add_argument(
        "--result-path",
        default="experiments/seabed_versions/v6_semantic_tie_break/results",
    )
    parser.add_argument("--model-path", default="model_save/")
    parser.add_argument("--model-name", default="GEDRankerSEABED_v6_semantic_tie_break")
    ...
    parser.add_argument("--repair-mode", choices=["two_swap"], default="two_swap")
    ...
    parser.add_argument("--semantic-max-iterations", type=int, default=20)
    ...
    parser.add_argument("--max-saved-paths", type=int, default=100)
