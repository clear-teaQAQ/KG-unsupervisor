"""Arguments for isolated V8 exact-embedding anchor evaluation."""
...
def parameter_parser():
    parser = argparse.ArgumentParser(
        description="Evaluate dual-cost-preserving exact embedding anchors."
    )
    ...
    parser.add_argument(
        "--result-path",
        default="experiments/seabed_versions/v8_exact_embedding_anchor/results",
    )
    parser.add_argument("--model-path", default="model_save/")
    parser.add_argument("--model-name", default="GEDRankerSEABED_v8_exact_embedding_anchor")
    ...
    parser.add_argument("--anchor-max-iterations", type=int, default=20)
