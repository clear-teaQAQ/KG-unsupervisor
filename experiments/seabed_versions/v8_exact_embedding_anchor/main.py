...
from anchor_trainer import ExactEmbeddingAnchorTrainer
...
def main():
    ...
    if args.anchor_max_iterations < 0 or args.max_saved_paths < 0:
        raise ValueError("Iteration and saved-path limits must be non-negative.")
    trainer = ExactEmbeddingAnchorTrainer(args)
